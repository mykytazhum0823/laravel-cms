...
Route::post('two-factor/resendcode', 'Auth\LoginController@resendcode')
            ->name('two-factor.resendcode');
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::group(['prefix' => 'profile', 'namespace' => 'Profile'], function () {
        ...
        Route::get('theme', 'ProfileController@themeUpdate')->name('profile.update.theme');
        Route::get('sidebar', 'ProfileController@sidebarUpdate')->name('profile.update.sidebar');
    ...
    Route::post('settings/general/copyright', 'SettingsController@copyrightUpdate')->name('settings.general.copyright')
        ->middleware('permission:settings.general');    
        

    Route::post('settings/general/logo', 'SettingsController@logoUpdate')->name('settings.general.logo.update')
        ->middleware('permission:settings.general');
    
    Route::post('settings/general/logo/delete', 'SettingsController@logoDelete')->name('settings.general.logo.delete')
    ->middleware('permission:settings.general');

    Route::post('settings/general/favicon', 'SettingsController@faviconUpdate')->name('settings.general.favicon.update')
        ->middleware('permission:settings.general');
    
    Route::post('settings/general/favicon/delete', 'SettingsController@faviconDelete')->name('settings.general.favicon.delete')
    ->middleware('permission:settings.general');

    Route::post('settings/general/smtp', 'SettingsController@smtpUpdate')->name('settings.general.smtp')
        ->middleware('permission:settings.general');

    Route::post('settings/general/color', 'SettingsController@mainColorUpdate')->name('settings.general.color')
        ->middleware('permission:settings.general');
        
    Route::post('settings/general/unlimited', 'SettingsController@unlimitedImageUpdate')->name('settings.general.unlimited.update')
        ->middleware('permission:settings.general');

    Route::post('settings/general/unlimited/delete', 'SettingsController@unlimitedImageDelete')->name('settings.general.unlimited.delete')
        ->middleware('permission:settings.general');

    Route::post('settings/general/logimage', 'SettingsController@logImageUpdate')->name('settings.general.logimage.update')
        ->middleware('permission:settings.general');

    Route::post('settings/general/logimage/delete', 'SettingsController@logImageDelete')->name('settings.general.logimage.delete')
        ->middleware('permission:settings.general');
    ...
    Route::get('settings/reviews', 'SettingsController@reviews')
        ->name('settings.reviews');

    Route::post('settings/reviews', 'SettingsController@reviewsUpdate')
        ->name('settings.reviews.update');
    
    Route::get('settings/reviews/create', 'SettingsController@reviewsCreate')
        ->name('settings.reviews.create');
    
    Route::post('settings/reviews/store', 'SettingsController@reviewsStore')
        ->name('settings.reviews.store');

    Route::get('settings/reviews/edit', 'SettingsController@reviewsEdit')
        ->name('settings.reviews.edit');

    Route::any('settings/reviews/delete', 'SettingsController@reviewsDelete')
        ->name('settings.reviews.delete');

    Route::get('settings/email', 'SettingsController@emailTemplate')
        ->name('settings.email');

    Route::post('settings/email/newaccount', 'SettingsController@changeEmailNewAccount')
        ->name('settings.email.newaccount');

    Route::post('settings/email/login', 'SettingsController@changeEmailLogin')
        ->name('settings.email.login');

    Route::post('settings/email/password', 'SettingsController@changeEmailPassword')
        ->name('settings.email.password');

    Route::post('settings/email/twofa', 'SettingsController@changeEmail2FA')
        ->name('settings.email.twofa');

    Route::get('settings/smtp', 'SettingsController@smtpIndex')
        ->name('settings.smtp');
